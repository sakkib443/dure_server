    ...
    async get() {
        ...
        if (!content) {
            content = await SiteContent.create({
                ...
                seo: {
                    title: 'Chutli - Premium Online Shopping Experience',
                    description: 'Shop the latest products with amazing deals at Chutli. Premium quality products at best prices.',
