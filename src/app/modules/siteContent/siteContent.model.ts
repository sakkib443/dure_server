...
const siteContentSchema = new Schema({
    ...
    // ── Footer ──
    footer: {
        companyName: { type: String, default: 'Chutli' },
    ...
    // ── SEO / Meta ──
    seo: {
        title: { type: String, default: 'Chutli - Premium Online Shopping Experience' },
        description: { type: String, default: 'Shop the latest products with amazing deals at Chutli.' },
